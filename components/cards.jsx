...
const Cards = () => {
  return (
    <div id="cards" className="cardsContainer flex flex-col bg-gradient-to-b from-indigo-600 via-blue-600 to-blue-600 gap-5 relative z-0 max-w-[1440px] mx-auto min-h-[85vh] pb-[80px]">
